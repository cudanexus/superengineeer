/**
 * @module StateModule
 * @description Centralized application state management for Superengineer-v5.
...
(function(root, factory) {
   ...
   * @returns {Superengineer-v5.ApplicationState} Default state object with all initial values
   * @example
   ...
   * @memberof module:StateModule
   * @param {Superengineer-v5.ApplicationState} [initialState] - Optional initial state, defaults to createDefaultState()
  ...
  function createStateManager(initialState) {
     ...
     * @returns {Superengineer-v5.ApplicationState} The entire state object
     * @example
