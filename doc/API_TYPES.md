...
Complete reference for all API response types in the Superengineer-v5 frontend type system.
...
ApiClient.getProjectDetails(projectId)
  .done(function(/** @type {Superengineer-v5.API.ProjectStatus} */ project) {
...
ApiClient.getAgentStatus(projectId)
  .done(function(/** @type {Superengineer-v5.API.AgentStatus} */ status) {
    if (status.running) {
...
ApiClient.getContextUsage(projectId)
  .done(function(/** @type {Superengineer-v5.API.ContextUsage} */ usage) {
...
ApiClient.getGitStatus(projectId)
  .done(function(/** @type {Superengineer-v5.API.GitStatus} */ status) {
...
ApiClient.startRalphLoop(projectId, config)
  .done(function(/** @type {Superengineer-v5.API.RalphLoopState} */ state) {
